...
const client = await readFile(new URL('../lib/index.js', import.meta.url), 'utf8')
...
assert.deepEqual(emittedFiles, ['host.mjs', 'index.js'], 'DSH client must remain a single bundle')
